...
import { Leaf, Mail, Lock, Eye, EyeOff, Play, ShieldCheck, Cloud, Shield, Umbrella, Users, CheckCircle, BarChart3 } from 'lucide-react';
      ...
      <div style={{ flex: 1, display: 'flex' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px', margin: '20px 0' }}>
            <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--color-tf-border)' }} />
            <span style={{ fontSize: '11px', color: 'var(--color-tf-text-dim)' }}>OR</span>
            <div style={{ flex: 1, height: '1px', backgroundColor: 'var(--color-tf-border)' }} />
          </div>
          ...
          >
            <Play size={16} fill="var(--color-tf-green)" />
            Enter Demo Environment
          </button>

          <p style={{ fontSize: '11px', color: 'var(--color-tf-text-dim)', textAlign: 'center', marginTop: '8px' }}>
            Demo access gives you full access to explore the platform.
          </p>
